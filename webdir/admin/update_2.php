...
print"<meta http-equiv=\"refresh\" content=\"2; URL=maske_update_2.php?offset=$offset&sart=$K003\">";
print"<p>Wenn die automatische Weiterleitung nicht funktioniert klicken sie <a href = \"maske_update_2.php?offset=$offset&sart=$K003\"> hier</a></p>";
mysql_close($connect);
?>
</body>
</html>